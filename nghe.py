...
# Set up pyttsx3 to use a Vietnamese voice if available
voices = robot_mouth.getProperty('voices')
for voice in voices:
    if 'vi' in voice.id or 'vietnam' in voice.name.lower():
        robot_mouth.setProperty('voice', voice.id)
        break

# Adjust the speaking rate
rate = robot_mouth.getProperty('rate')
robot_mouth.setProperty('rate', rate - 50)  # Decrease the rate by 50 (you can adjust this value as needed)
